...
void AUnrealPlaygroundCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AUnrealPlaygroundCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AUnrealPlaygroundCharacter::Look);
	}
	else
	{
...
void AUnrealPlaygroundCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AUnrealPlaygroundCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
